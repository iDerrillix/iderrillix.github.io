...
<head>
    ...
    <title>Feedbacks | 1ne Admin</title>
</head>
<body>
    <?php 
                ...
                <?php 
                    ...
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        <tr>
                            ...
                            <td>".$row['f_status']."</td>
                            <td><a href='feedbacks.php?id=".$row['feedback_id']."&action=resolve' class='input-btn' style='text-decoration: none; background-color: lightgreen;'><i class='fa-solid fa-check'></i></a> <a href='feedbacks.php?id=".$row['feedback_id']."&action=remove' class='input-btn' style='text-decoration: none; background-color: red;'><i class='fa-solid fa-trash'></i></a></td>
                        </tr>
                        ";
                    }
                ?>
